...
portName = 'COM8'                      # Communications port name. Make sure it matches port in Arduino IDE
...
# OL Gain
OLgain = 0.6394960965223564 # [PWM/(rad/s)]

# Closed loop gains
Kp = 0.9    # Determine units     
Ki = 1.0   # Determine units      
Kd = 0.01  # Determine units
...
fileName     = 'Lab10_CL_Step_20Hz.csv'
...
# commandData  = [OLgain,  Kp,  Ki,  Kd,   0, 300, 200,   0, 300, 200,   0] # Value to send over
# commandTypes = [   'f', 'P', 'I', 'D', 'k', 'k', 'k', 'k', 'c', 'c', 'k'] # Type of command to send


# uncomment for sine wave
fileName     = 'Lab10_CL_sine_CL_20Hz.csv'
