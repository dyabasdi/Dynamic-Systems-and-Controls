...
int motorPwm = 150; // 140 is minimum to overcome stiction in my motor
float PWMout = 255;
float PWM_ratio = 0;
...
// ------------------------------------------------------------------------------------------------------------
float OL_gain = 0.6394960965223564; // Solve for units
float kp = 0.90;      // Solve for units, adjust with 0.1 increments
float ki = 0.30;      // Solve for units, adjust with 0.1 increments
float kd = 0.01;     // Solve for units, start very small here (e.g., kd = 0.001), adjust with 0.001 increments
...
void setup() {
  ...
  //Serial.println("Press t for jump to 300 [rad/s]");
